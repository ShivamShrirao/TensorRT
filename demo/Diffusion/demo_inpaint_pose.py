...
def parseArgs():
    ...
    parser.add_argument('--version', type=str, default="1.5", help="Stable Diffusion version. Only 1.5 and 2.0 supported for inpainting.")
...
if __name__ == "__main__":
    print("[I] Initializing StableDiffusion inpainting pose demo using TensorRT")
    args = parseArgs()
    ...
    demo = StableDiffusionPipeline(
        pipeline_type=PIPELINE_TYPE.INPAINT_POSE,
